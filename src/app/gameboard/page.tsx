...
export default function Gameboard() {
    ...
    const renderWordPlaceholders = () => {
        ...
        return gameState.word.split('').map((letter, index) => (
            <div key={index}
                className='w-10 h-16 sm:w-20 sm:h-28 lg:w-28 lg:h-32 mx-2 shadow-category-btn rounded-2xl bg-light-blue flex justify-center items-center text-heading-m lg:text-heading-l'
            >
